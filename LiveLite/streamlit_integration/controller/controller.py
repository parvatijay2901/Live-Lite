...
from recommendation_tool.handle_user_input.user_input_mapping import get_mapped_user_inputs
from recommendation_tool.risk_assessment.risk_score import generate_input_for_risk_score, generate_risk_score_display
...
def controller(choice):
    ...
    if choice == "physical_activity_recommender":
        filename = "data/files/calories_burned_30_minutes.csv"
