...
def controller(choice):
    ...
    if choice == "estimate_calorie_intake":
        calorie_intake = recommendation_tool.calculate_calorie_intake(mapped_user_inputs['internal_weight'],
    ...
    if choice == "diet_recommender":
        macro_nutrients_df = recommendation_tool.macro_nutrients_data(mapped_user_inputs['internal_age'], mapped_user_inputs['internal_sex'], st.session_state['calorie_intake'])
        micro_nutrients_df = recommendation_tool.micro_nutrients(mapped_user_inputs['internal_age'], mapped_user_inputs['internal_sex'])
