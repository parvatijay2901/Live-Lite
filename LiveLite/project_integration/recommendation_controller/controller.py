...
def controller(choice):
    ...
    if choice == "risk_score":
        ...
        if is_obese:
            ...
            model = """LiveLite/recommendation_tool/risk_assessment/
            trained_models/obesity_risk_model.joblib"""
    ...
    if choice == "diet_recommender_advanced_based_on_food_preference":
        ...
        recommended_foods_df = LiveLite.recommended_food(food_nutrition_data,
                                                        risk_score, food_preference)
    ...
    if choice == "physical_activity_recommender":
        ...
        physical_activity_list = LiveLite.calculate_calorie_burn(filename,
                                                            mapped_user_inputs['internal_weight'],
                                                            intensity=intensity)
