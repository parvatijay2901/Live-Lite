...
with col1:
   ...
   with col11:
      st.markdown("""<p style='text-align:center; color:teal; font-weight:bold;'>Delve into the multifaceted landscape
   ...
   with col12:
      st.markdown("""<p style='text-align:center; color:teal; font-weight:bold;'>Receive valuable insights to
...
with col2:
   ...
   st.image("streamlit_app/images/logo.png", width=300)

project_integration.add_blank_lines(num_lines=8)
