...
from data_analysis.research_analysis import background_information_ihme, background_information_nhanes, obesity_trends, violin_plot_manager
...
fig = background_information_ihme(years=[1990, 2019]) 
st.plotly_chart(fig, use_container_width=True, width=1200, height=600) # Check the color issue with this plot, reduce the text on the y axis?
...
fig = violin_plot_manager(years=[1999, 2017])
